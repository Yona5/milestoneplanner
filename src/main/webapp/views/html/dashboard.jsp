    ...
    <div class="left">
        ...
        <div class="navigation">
            <ul>
                ...
                <li><a href="project.jsp"><i class="material-icons">view_agenda</i><span>Projects</span></a></li>
                <li><a href="#"><i class="material-icons">track_changes</i><span>Collaborators</span></a></li>
                <li><a href="#"><i class="material-icons">developer_board</i><span>Timeframes</span></a></li>
                <li><a href="#"><i class="material-icons">forum</i><span>Message</span></a></li>
            </ul>
        </div>
    </div>
    <div class="right">
        ...
        <div class="row column">
            <div class="jumbotron">
                ...
                <p class="lead">Welcome to MilestonePlanner. It is your place to organize your major goals, projects and enjoy the best experience.</p>
                <hr class="my-4">
                <p>Create your projects on this platform and breakdown in milestones. Deliver your content on time, and have fun.</p>
                <p class="lead">
